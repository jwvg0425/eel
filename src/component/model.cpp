...
void eel::Model::AddShaderResource(const std::string& name, ShaderResource&& resource)
{
	std::pair<std::string, ShaderResource> pair(name, std::move(resource));
